...
class ServiceManager:
    ...
    def run(self):
        ...
        print()
        print("=" * 60)
        print("  TRADING RULES v2.1 (Anti-PDT)")
        print("=" * 60)
        print("   📈 Buy:  TRUE DIP only (Mom1d < 0, below SMA5)")
        ...
        print("=" * 60)
        print("   ✓ Mom 1d < 0 (true dip, not bounce)")
        print("   ✓ No gap-up > 1.5%")
        print("   ✓ Below SMA5 (real pullback)")
        print("   ✓ ATR-based SL (wider for volatile)")
        print()
        print("=" * 60)
        print("  MONITORS")
        print("=" * 60)
