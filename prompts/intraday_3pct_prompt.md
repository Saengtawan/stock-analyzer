...
|---|--------|-------|-----|-----|-----|--------|
| 1 | XXX | $XX | $XX (-X%) | $XX (+X%) | 1:X | สั้นๆ 1 บรรทัด |

**XXX**: เหตุผลหลัก 1 บรรทัด
- Risk: อะไรที่อาจผิด 1 บรรทัด
...
**ต่อตัว 2 บรรทัด** — ทำไมน่าสนใจ + รออะไร
Re-check: เวลา + เงื่อนไข (1 บรรทัด)
```
