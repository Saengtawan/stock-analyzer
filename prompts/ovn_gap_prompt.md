...
Baseline OVN gap = noise — combo signals ช่วยกรอง
...
→ combo กับ direction (momentum, catalyst) ช่วยเพิ่ม WR
...
→ อังคาร/พุธ gap rate สูงสุด | พฤหัสบดี gap rate ต่ำสุด (1.5%)
...
→ Last hour pattern ไม่ทำนาย OVN gap — signal อื่นดีกว่า
...
### 3. Filter
- **Sector**: ดูตาราง gap rate ต่อ sector (เปลี่ยนตาม rotation)
- **Day**: อังคาร/พุธ gap rate สูงสุด, พฤหัสบดีต่ำสุด (1.5%)
- **Catalyst**: earnings AMC, FDA after hours, M&A rumor = โอกาสพุ่ง
- **Mcap**: ไม่จำกัด (OVN gap เกิดทุก size)

### 4. Risk Check
- Spike + Vol 3x+ ไม่มี momentum = risk -3% สูง 8.3%
...
| Setup | หมายเหตุ |
|-------|---------|
| Vol 3x+ แต่ momentum < 0 | symmetric risk ไม่คุ้ม |
| Spike 5%+ วันเดียว ไม่มี 5d trend | mean reversion risk |
| พฤหัสบดี + ไม่มี catalyst | gap แย่สุดของสัปดาห์ |
